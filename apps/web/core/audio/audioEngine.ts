...
const RECIPES: Record<SoundName, Voice[]> = {
  select: [
    { freq: N.A4!, type: "sine", dur: 0.07, gain: 0.16, cutoff: 2600, space: 0.1 },
  ],
  move: [
    {
      freq: 196,
  ...
  promotion: chord(
    [N.C4!, N.E4!, N.G4!, N.C5!, N.E5!],
    { type: "triangle", dur: 0.34, gain: 0.17, space: 0.42, attack: 0.01 },
    0.06,
  ),
  check: [
  ...
  success: [
    ...chord(
      [N.C5!, N.E5!, N.G5!],
      { type: "sine", dur: 0.2, gain: 0.2, space: 0.38, attack: 0.006 },
      0.045,
    ),
    {
      freq: N.C6!,
  ...
  reward: chord(
    [N.E5!, N.A5!, N.C6!, N.E6!],
    { type: "triangle", dur: 0.24, gain: 0.18, space: 0.48, attack: 0.008 },
    0.07,
  ),
  streak: chord(
    [N.G4!, N.B4!, N.D5!, N.G5!],
    { type: "sine", dur: 0.2, gain: 0.18, space: 0.42, attack: 0.008 },
    0.06,
  ),
  levelup: chord(
    [N.C5!, N.G5!, N.C6!, N.E6!],
    { type: "sine", dur: 0.32, gain: 0.18, space: 0.52, attack: 0.01 },
    0.09,
  ),
  unlock: [
  ...
  exam: chord(
    [N.D4!, N.F4!, N.A4!],
    { type: "sine", dur: 0.22, gain: 0.18, space: 0.3 },
    0.05,
  ),
  ...
  graduation: [
    ...chord(
      [N.C4!, N.E4!, N.G4!],
      { type: "triangle", dur: 0.3, gain: 0.18, space: 0.5 },
      0.04,
    ),
    ...chord(
      [N.F4!, N.A4!, N.C5!],
      { type: "triangle", dur: 0.3, gain: 0.18, delay: 0.22, space: 0.5 },
      0.04,
    ),
    ...chord(
      [N.G4!, N.B4!, N.D5!],
      { type: "triangle", dur: 0.3, gain: 0.18, delay: 0.44, space: 0.5 },
      0.04,
    ),
    ...chord(
      [N.C5!, N.E5!, N.G5!, N.C6!],
      { type: "sine", dur: 0.6, gain: 0.2, delay: 0.66, space: 0.6 },
      0.05,
    ),
  ],
  victory: [
    ...chord(
      [N.C5!, N.E5!, N.G5!],
      { type: "triangle", dur: 0.16, gain: 0.2, space: 0.4 },
      0.05,
    ),
    {
      freq: N.C6!,
  ...
  ambience: chord([N.C3!, N.G3!, N.C4!, N.E4!], {
    type: "sine",
    dur: 1.6,
    gain: 0.06,
    cutoff: 1400,
  ...
  install: chord(
    [N.C5!, N.E5!, N.G5!, N.C6!],
    { type: "sine", dur: 0.3, gain: 0.2, space: 0.55 },
    0.09,
  ),
};
...
class AudioEngine {
  ...
  play(name: SoundName): void {
    if (!this.enabled || !this.ensure() || !this.ctx || !this.master || !this.spaceBus)
      return;
    if (this.ctx.state === "suspended") void this.ctx.resume();
