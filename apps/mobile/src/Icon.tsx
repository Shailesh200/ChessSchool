import Svg, { Path, Rect, Circle, Ellipse, type NumberProp } from "react-native-svg";
...
export function Icon({
  ...
  const duo = { fill: color, opacity: 0.28 };
  const d = duotone;
  ...
  const icons: Record<IconName, React.ReactNode> = {
    ...
    play: (
      ...
      <Path d="M10 9.5l5 2.5-5 2.5z" {...s} fill={color} />
    </>
    ),
    review: (
      <>
    ...
    undo: (
      <Path d="M4 9h9a5 5 0 0 1 0 10h-4M4 9l4-4M4 9l4 4" {...s} />
    ),
    flip: (
    ...
    compass: (
      ...
      {d && <Circle cx="12" cy="12" r="8.5" {...duo} />}
      <Circle cx="12" cy="12" r="8.5" {...s} />
      <Path d="M15.5 8.5l-2 5-5 2 2-5z" {...s} fill={color} />
    </>
    ),
    eye: (
      <>
    ...
    redo: (
      <Path d="M4 9h9a5 5 0 0 1 0 10h-4M20 9l-4-4M20 9l-4 4" {...s} />
    ),
    skipBack: (
      <>
      <Path d="M6 7v10" {...s} />
    ...
    wifi: (
      <>
      {d && <Circle cx="12" cy="18" r="1.2" fill={color} />}
      <Path
    ...
    queen: (
      ...
      <Circle cx="12" cy="5.5" r="0.8" fill={color} />
