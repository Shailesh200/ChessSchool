...
export default function ArenaScreen() {
  ...
  const url = "https://chess-school.in/play/arena";
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <View style={styles.center}>
        <Cody expression="cheer" size={112} />
        <Text style={styles.title}>Arena on web (for now)</Text>
        <Text style={styles.body}>
          The 4-bot round robin arena with standings is on the web app while we build the native
          tournament hub.
        </Text>
