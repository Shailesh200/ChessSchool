...
check "about page" "[ -f '$WEB/app/about/page.tsx' ]"
check "support page" "[ -f '$WEB/app/support/page.tsx' ]"
check "terms page" "[ -f '$WEB/app/terms/page.tsx' ]"
...
check "launch runbook" "[ -f '$ROOT/plans/M-073_WEB_GA_LAUNCH.md' ]"
check "env docs" "[ -f '$ROOT/docs/ENV.md' ]"
